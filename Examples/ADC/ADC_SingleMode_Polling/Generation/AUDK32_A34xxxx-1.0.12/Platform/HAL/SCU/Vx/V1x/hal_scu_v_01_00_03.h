/**
 *******************************************************************************
 * @file        hal_scu_v_01_00_03.h
 * @author      ABOV R&D Division
 * @brief       Private APIs for ver 01.00.03 typed SCU
 *
...
#ifndef _HAL_SCU_V_01_00_03_H_
#define _HAL_SCU_V_01_00_03_H_
...
#define SCU_FEATURE_LSI_LOW_DROPOUT
#define SCU_FEATURE_UNSUPPORT_RESET_LSE
#define SCU_FEATURE_POWER_BACKUP_MODE
#define SCU_FEATURE_BACKUP_DATA
...
#define SCU_PREVMODE_DEEPSLEEP                        0x07
...
#define SCUCLK_FMC_CLK_WAIT_3                         48000000
#define SCUCLK_FMC_CLK_WAIT_4                         48000000
#define SCUCLK_FMC_CLK_WAIT_5                         48000000
...
#else
#define SET_SCU_CSCR_HSE(Peri,Data)                   SET_BIT_KEY(Peri,0xA507,Data,SCU,CSCR,MOSCCON)
#define SET_SCU_CSCR_LSE(Peri,Data)                   SET_BIT_KEY(Peri,0xA507,Data,SCU,CSCR,SOSCCON)
...
#define SET_SCU_SCCR_PLLCLKSEL(Peri,Data)             SET_BIT_KEY(Peri,0x570A,Data,SCU,SCCR,FINSEL)
#endif
...
#define SET_SCU_PDR_EN(Peri,Data)                     SET_BIT_KEY_BITNAME(Peri,0xA,PDRCON_WTIDKY,Data,SCU,PDRCON,PDREN)
...
#define SET_SCU_LSI_LDO_EN(Peri,Data)                 SET_BIT(Peri,Data,SCU,LSICON,EN_LDO)
...
#define SET_SCU_VDC_DEEPSLEEP(Peri,Data)              SET_BIT_KEY_BITNAME(Peri,0x5,VDC15_WTIDKY,Data,SCU,VDCCON,VDC15_STOP)
...
/* Unused Macro */
#define BIT_SCU_SMR_LSI_POS                           (void)0
...
#define SET_SCU_COR_CLKOINSEL(Peri,Data)              (void)Peri
#define SET_SCU_SCCR_HCLKDIV(Peri,Data)               (void)Peri
...
#define SET_RTC_DR_BACKUP(Addr,Offset,Data)           SET_BIT_ADDR_OFFSET(Addr,Offset,Data,RTC,BKUPDR1,BKUPDR)
#define GET_RTC_DR_BACKUP_ADDR(Peri)                  GET_REG_ADDR(Peri,BKUPDR1)

/* inline function */
static __inline void SCUPWR_SetBackupData(uint8_t un8Num, uint32_t un32Data)
{
    RTC_Type *ptRtc = (RTC_Type *)RTC_REG_BASE;
    uint32_t un32RegAddr = (uint32_t)GET_RTC_DR_BACKUP_ADDR(ptRtc);
    SET_RTC_DR_BACKUP(un32RegAddr, (un8Num * 4), un32Data);
}

static __inline void SCUPWR_GetBackupData(uint8_t un8Num, uint32_t *pun32Data)
{
    RTC_Type *ptRtc = (RTC_Type *)RTC_REG_BASE;
    uint32_t un32RegAddr = (uint32_t)(GET_RTC_DR_BACKUP_ADDR(ptRtc) + un8Num);
    *pun32Data = (uint32_t)(*(volatile uint32_t *)un32RegAddr);
}

#endif /* _HAL_SCH_V_01_00_03_H_ */
