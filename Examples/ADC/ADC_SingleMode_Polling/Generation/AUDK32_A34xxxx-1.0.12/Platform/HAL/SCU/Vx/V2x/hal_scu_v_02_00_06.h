/**
 *******************************************************************************
 * @file        hal_scu_v_02_00_06.h
 * @author      ABOV R&D Division
 * @brief       Private APIs for v 02.00.01 typed SCU
 *
...
#ifndef _HAL_SCU_V_02_00_06_H_
#define _HAL_SCU_V_02_00_06_H_

/* Feature(Function) Configuration Define */
#define SCU_FEATURE_UNSUPPORT_LSE
...
#define SCU_FEATURE_PLL_OUTPUT_FORMULA_V4
...
#define SCUCLK_FMC_CLK_WAIT_0                         28000000
#define SCUCLK_FMC_CLK_WAIT_1                         56000000
#define SCUCLK_FMC_CLK_WAIT_2                         84000000
#define SCUCLK_FMC_CLK_WAIT_3                         96000000
#define SCUCLK_FMC_CLK_WAIT_4                         96000000
#define SCUCLK_FMC_CLK_WAIT_5                         96000000
...
#define SET_SCU_PLLCON_POSTDIV1(Peri,Data)            SET_BIT(Peri,Data,SCU,PLLCON,POSTDIV)
...
#define SET_SCU_PLLCON_OUTDIV_POS(Data)               SET_POS((Data & 0x0F),SCU,PLLCON,LOOPDIV)
#define SET_SCU_PLLCON_POSTDIV1_POS(Data)             SET_POS((Data & 0xFF),SCU,PLLCON,POSTDIV)
...
/* Unused Macro */
#define SET_SCU_CSCR_LSE(Peri,Data)                   (void)Peri
#define GET_SCU_CMR_MCLKSTS(Peri)                     0
...
#define SET_SCU_DFMC_LATENCY(Peri,Data)               SET_BIT(Peri,Data,DFMC,CONF,LATENCY)
#define SCU_FMC_DEFAULT_LATENCY                       5

#endif /* _HAL_SCH_V_02_00_06_H_ */
