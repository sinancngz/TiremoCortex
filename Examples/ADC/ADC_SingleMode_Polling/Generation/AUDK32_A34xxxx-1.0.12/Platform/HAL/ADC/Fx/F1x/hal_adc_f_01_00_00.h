...
#ifndef _HAL_ADC_F_01_00_00_H_
#define _HAL_ADC_F_01_00_00_H_
...
#define ADC_SEQTRG_SRC(x,y)                           (x == 1 ? x + y : x == 3 ? 4 : 0)
...
#define SET_ADC_CR_REF(Peri,Data)                     SET_BIT(Peri,Data,ADC,CR,REFSEL)
#define SET_ADC_CR_SEQTRG_SRC(Peri,Data,Offset)       SET_BIT_OFFSET(Peri,0x00,Data,ADC,CR,TRIG)
...
/* Interrupt Macro */
#define SET_ADC_IER_SINGLE_EN(Peri,Data)              SET_BIT(Peri,Data,ADC,CR,ADCIEN)
#define SET_ADC_IER_SINGLE_FLAG(Peri,Data)            SET_BIT(Peri,Data,ADC,CR,ADCIFLAG)
#define GET_ADC_IER_SINGLE_FLAG(Peri)                 GET_BIT(Peri,ADC,CR,ADCIFLAG)
