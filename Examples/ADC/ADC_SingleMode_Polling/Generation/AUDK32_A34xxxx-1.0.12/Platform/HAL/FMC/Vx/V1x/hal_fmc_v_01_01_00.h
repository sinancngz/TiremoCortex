/**
 *******************************************************************************
 * @file        hal_fmc_v_01_01_00.h
 * @author      ABOV R&D Division
 * @brief       Private APIs for ver 01.01.00 typed FMC
 *
...
#ifndef _HAL_FMC_V_01_01_00_H_
#define _HAL_FMC_V_01_01_00_H_
...
#define FMC_FEATURE_CFMC_BANK_SWITCH_CMD_TYPE         1
...
#define FMC_FEATURE_CFMC_BANK_SWITCH_CMD_OFFSET       0x00400000
...
#define FMC_WPROT_WPROT_Mask                          0x30FF3FFF
...
#define SET_CFMC_CR_OTP_BANK_SWITCH(Peri,Data)        SET_BIT(Peri,Data,FMC,PROTECT,BANKSWAPOTP)
...
#define SET_FMC_CR_ERS_2KB(Peri,Data)                 SET_BIT(Peri,Data,FMC,CON,SERA)
...
#define SET_CFMC_BCR_MULTI_BANK_CONF(Peri,Data)       SET_BIT_KEY(Peri, CFMC_BCR_WKY_BANK_SW_KEY, Data, FMC, BCR, BSE)
#define SET_CFMC_BCR_BANK_SWITCH(Peri,Data)           SET_BIT_KEY(Peri, CFMC_BCR_WKY_BANK_SW_KEY, Data, FMC, BCR, BSW)
#define GET_CFMC_BCR(Peri)                            GET_REG(Peri,BCR)
#define GET_CFMC_BSR_BANK_SWITCH_DONE(Peri)           GET_BIT(Peri,FMC,BSR,BSWST)
#define GET_CFMC_BSR_ACTIVE_BANK(Peri)                GET_BIT(Peri,FMC,BSR,BSST)
#define GET_CFMC_BSR_BOOT_BANK(Peri)                  GET_BIT(Peri,FMC,BSR,CBF)
...
RAMFUNC static __inline void CFMC_WriteToUserInfo(volatile uint32_t un32FlashAddr, uint32_t *pun32Data, uint32_t un32Len, PRV_CMFC_USERINFO_ID_e eUserInfoID)
{
    ...
    {
        SET_CFMC_CR_OTP_BANK_SWITCH(ptRegBase, 1UL);
    }
