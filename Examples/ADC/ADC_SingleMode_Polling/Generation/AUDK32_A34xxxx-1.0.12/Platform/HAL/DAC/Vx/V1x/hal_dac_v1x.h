 ...
 * @brief       Private APIs for V1x typed DAC
 *
...
#ifndef _HAL_DAC_V1X_H_
#define _HAL_DAC_V1X_H_
...
static __inline HAL_ERR_e DAC_SetOutPort(DAC_Type *ptDac, uint8_t un8OutPort)
{
    ...
    {
        SET_DAC_CR_PORT_EN(ptDac, true);
    }
    else
    {
        SET_DAC_CR_PORT_EN(ptDac, false);
    }

    return HAL_ERR_OK;
}

#endif /* _HAL_DAC_V1X_H_ */
