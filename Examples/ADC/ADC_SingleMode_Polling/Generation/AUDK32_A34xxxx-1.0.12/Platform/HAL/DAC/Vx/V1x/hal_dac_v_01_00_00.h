/**
 *******************************************************************************
 * @file        hal_dac_v_01_00_00.h
 * @author      ABOV R&D Division
 * @brief       Private APIs for ver 01.00.00 typed DAC
 *
...
#ifndef _HAL_DAC_V_01_00_00_H_
#define _HAL_DAC_V_01_00_00_H_

/* Feature(Function) Configuration Define */

/* Internal Macro */
#define DAC_REG_BASE                                  DAC_BASE
#define DAC_DR_SHIFT                                  3
#define DAC_RELOAD(x)                                 (0)
#define DAC_RESOLUTION                                31

/* Bit/Register Macro */
#define SET_DAC_CR_EN(Peri,Data)                      SET_BIT(Peri,Data,DAC,CR,DACEN)
#define SET_DAC_CR_PORT_EN(Peri,Data)                 SET_BIT(Peri,Data,DAC,DACEN,DACPORT)
#define SET_DAC_DR_IN(Peri,Data)                      SET_BIT(Peri,Data,DAC,DR,DADTA)
#define GET_DAC_DR_OUT(Peri)                          GET_BIT(Peri,DAC,DR,DADTA)
