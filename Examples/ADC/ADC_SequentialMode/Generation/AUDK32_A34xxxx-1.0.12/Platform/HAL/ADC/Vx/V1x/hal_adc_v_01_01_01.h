...
#ifndef _HAL_ADC_V_01_01_01_H_
#define _HAL_ADC_V_01_01_01_H_

/* Feature(Function) Configuration Define */
#define ADC_FEATURE_MCCR_CLOCK
#define ADC_FEATURE_COMPARATOR
#define ADC_FEATURE_BUFFER_DELAY
...
#define ADC_TRG_SRC(x)                                (x == 3 ? 2 : (x > 2) ? 3 : x)
#define ADC_SEQTRG_SRC(x,y)                           (x == 0 ? 15 : x == 1 ? y : (x == 3) ? 0 : ADC_NO_TRG_SOURCE)
...
#define SET_ADC_CR_ADCPDA(Peri,Data)                  SET_BIT(Peri,Data,ADC,CRC,ADCPDA)
#define SET_ADC_CR_ADCPD(Peri,Data)                   SET_BIT(Peri,Data,ADC,CCR,ADCPDA); \
                                                      SET_BIT(Peri,Data,ADC,CCR,ADCPD)
...
#define SET_ADC_CR_BUF_DLY_EN(Peri,Data)              SET_BIT(Peri,Data,ADC,BCR,BUFEN)
#define SET_ADC_CR_BUF_DLY_SEL(Peri,Data)             SET_BIT(Peri,Data,ADC,BCR,TBUFSEL)
#define SET_ADC_CR_BUF_DLY_BYPASS(Peri,Data)          SET_BIT(Peri,Data,ADC,BCR,BYPSEL)
...
#define GET_ADC_IER_CMP_FLAG(Peri)                    GET_BIT(Peri,ADC,SR,CMPIFLG)
#define SET_ADC_IER_CMP_FLAG(Peri,Data)               SET_BIT_FLAG(Peri,Data,ADC,SR,CMPIFLG)
...
#define SET_SCU_ADC_MCCR_SEL(Peri,Data)               SET_BIT(Peri,Data,SCU,MCCR7,ADCCSEL)
#define SET_SCU_ADC_MCCR_DIV(Peri,Data)               SET_BIT(Peri,Data,SCU,MCCR7,ADCCDIV)

#endif /* _HAL_ADC_V_01_01_01_H_ */
