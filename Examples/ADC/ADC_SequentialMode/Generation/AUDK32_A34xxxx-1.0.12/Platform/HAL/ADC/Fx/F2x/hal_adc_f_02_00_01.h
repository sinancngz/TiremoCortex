...
#ifndef _HAL_ADC_F_02_00_01_H_
#define _HAL_ADC_F_02_00_01_H_
...
#define ADC_SEQTRG_SRC(x,y)                           (x == 1 ? 1 + y : x != 7 ? 0 : x)
