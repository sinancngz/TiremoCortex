/**
 *******************************************************************************
 * @file        hal_pcu_v_02_00_03.h
 * @author      ABOV R&D Division
 * @brief       Private APIs for ver 02.00.03 typed PCU
 *
...
#ifndef _HAL_PCU_V_02_00_03_H_
#define _HAL_PCU_V_02_00_03_H_
...
#define PCU_ALTMODE_TYPE(x)                           (x < 5 ? x : 0x07)
...
#define PCU_GROUP_INTR_IDX(x)                         (x/2)
...
#define SET_PCU_ALT1(Peri,Data,Pos)                   SET_REG_BIT(Peri,Data,MR1,MASK_4BITS,Pos)
#define SET_PCU_ALT2(Peri,Data,Pos)                   SET_REG_BIT(Peri,Data,MR2,MASK_4BITS,Pos)
