/**
 *******************************************************************************
 * @file        hal_scu_v_04_00_01.h
 * @author      ABOV R&D Division
 * @brief       Private APIs for v 04.00.00 typed SCU
 *
...
#ifndef _HAL_SCU_V_04_00_01_H_
#define _HAL_SCU_V_04_00_01_H_
...
#define SCU_FEATURE_PCU_RESET_PIN_DEBOUNCE
#define SCU_FEATURE_NOT_SUPPORT_PREVMODE
#define SCU_FEATURE_UNSUPPORT_HSE
...
#define SCUCLK_FMC_CLK_WAIT_0                         25000000
#define SCUCLK_FMC_CLK_WAIT_1                         32000000
...
#define SET_SCU_PLLCON_CUROPT_POS(Data)               0
#define SET_SCU_PLLCON_VCOBIAS_POS(Data)              0
...
#define SET_SCU_CSCR_HSE(Peri,Data)                   (void)Peri
#define SET_SCU_CMR_HSEMNT(Peri,Data)                 (void)Peri
#define SET_SCU_CMR_HSEIE(Peri,Data)                  (void)Peri
#define SET_SCU_CMR_HSEFAIL(Peri,Data)                (void)Peri
#define GET_SCU_CMR_HSEFAIL(Peri)                     0
#define GET_SCU_CMR_HSESTS(Peri)                      0
...
#define BIT_SCU_SMR_HSI_POS                           BIT_NAME_POS(SCU_,SMR_,HSIAON_)
#define BIT_SCU_SMR_HSE_POS                           BIT_NAME_POS(SCU_,SMR_,HSEAON_)
...
#define SET_SCU_LVD_IND_AON(Peri,Data)                SET_BIT(Peri,Data,SCU,LVICR,LVIAON)
#define SET_SCU_LVD_IND_INTR_EN(Peri,Data)            SET_BIT(Peri,Data,SCU,LVICR,LVIINTEN)
#define SET_SCU_LVD_IND_INTR_FLAG(Peri,Data)          SET_BIT_KEY(Peri,0x7A,Data,SCU,LVISR,LVIIFLAG)
#define SET_SCU_LVD_RST_SEL(Peri,Data)                SET_BIT(Peri,Data,SCU,LVRCR,LVRVS)
#define SET_SCU_LVD_RST_AON(Peri,Data)                SET_BIT(Peri,Data,SCU,LVRCR,LVRAON)
...
#define SET_SCU_CLK_RST_SRC_HSE_EN(Peri,Data)         (void)Peri
#define GET_SCU_CLK_RST_SRC_HSE_EN(Peri)              0
#define SET_SCU_CLK_RST_SRC_HSE_FLAG(Peri,Data)       (void)Peri
#define GET_SCU_CLK_RST_SRC_HSE_FLAG(Peri)            0
