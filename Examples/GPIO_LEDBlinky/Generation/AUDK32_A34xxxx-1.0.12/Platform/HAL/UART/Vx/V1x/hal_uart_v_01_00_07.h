...
/* Internal Macro */
#define UART_REG_BASE                                 UART_BASE
...
#define SET_SCU_UART_PER(Peri,Id,Data)                SET_BIT_ID(Peri,Id,Data,SCU,PER2,UART)
#define SET_SCU_UART_PCER(Peri,Id,Data)               SET_BIT_ID(Peri,Id,Data,SCU,PCER2,UART)
