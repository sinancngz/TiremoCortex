...
#ifndef _HPL_NMI_V_01_00_0X_H_
#define _HPL_NMI_V_01_00_0X_H_
...
#define GET_SCU_NMI_LVD_IER_FLAG(Peri)                GET_BIT(Peri,SCU,NMIR,LVDSTS)
#define SET_SCU_NMI_TIMER3_BLNK(Peri,Data)            (void)Peri 
#define SET_SCU_NMI_CMP(Peri,Data)                    (void)Peri
#define SET_SCU_NMI_FLASH_SWAP(Peri,Data)             (void)Peri
#define GET_SCU_NMI_TIMER3_BLNK_IER_FLAG(Peri)        (void)0
#define GET_SCU_NMI_CMP_IER_FLAG(Peri)                (void)0
#define GET_SCU_NMI_FLASH_SWAP_IER_FLAG(Peri)         (void)0

#endif /* _HPL_NMI_V_01_00_0X_H_ */
