/**
 *******************************************************************************
 * @file        hpl_nmi_v_02_00_03.h
 * @author      ABOV R&D Division
 * @brief       Private APIs for ver 02.00.03 typed SCU NMI 
 *
...
#ifndef _HPL_NMI_V_02_00_03_H_
#define _HPL_NMI_V_02_00_03_H_
...
/* Bit/Register Macro */
#define SET_SCU_NMI_EN(Peri,Data)                     SET_BIT(Peri,Data,SCU,NMICR,NMIEN)
...
#define SET_SCU_NMI_WDT_IER_EN(Peri,Data)             SET_BIT(Peri,Data,SCU,NMICR,WDTEN)
#define GET_SCU_NMI_MCLK_IER_FLAG(Peri)               GET_BIT(Peri,SCU,NMISR,MCLKFAILSTS)
#define GET_SCU_NMI_WDT_IER_FLAG(Peri)                GET_BIT(Peri,SCU,NMISR,WDTSTS)
#define SET_SCU_NMI_WDT_IER_FLAG(Peri,Data)           SET_BIT(Peri,Data,SCU,NMISR,WDTSTS)
