...
static void GPIO_Configure(void)
{
    ...
    HAL_PCU_SetInOutMode(BOARD_LED6_PORT, BOARD_LED6_PIN, PCU_INOUT_OUTPUT_PUSH_PULL);

    HAL_PCU_SetAltMode(BOARD_USER_BTN_PORT, BOARD_USER_BTN_PIN, PCU_ALT_0);
    HAL_PCU_SetInOutMode(BOARD_USER_BTN_PORT, BOARD_USER_BTN_PIN, PCU_INOUT_INPUT);
    HAL_PCU_SetPullUpDown(BOARD_USER_BTN_PORT, BOARD_USER_BTN_PIN, PCU_PUPD_UP);
}
