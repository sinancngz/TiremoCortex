/**
 *******************************************************************************
 * @file        hal_fmc_v_03_00_02.h
 * @author      ABOV R&D Division
 * @brief       Private APIs for ver 03.00.02 typed FMC
 *
...
#ifndef _HAL_FMC_V_03_00_02_H_
#define _HAL_FMC_V_03_00_02_H_
...
/* Macro definition */
#define SET_CFMC_CFGR_DCACHE_RESET(Peri,Data)         (void)Peri
#define SET_CFMC_CFGR_ICACHE_RESET(Peri,Data)         (void)Peri
#define SET_CFMC_CFGR_DCACHE_EN(Peri,Data)            (void)Peri
...
#define SET_FMC_CFGR_WRITE_EN(Peri,Data)              SET_BIT(Peri,Data,CFMC,CONF,WRITE)
...
#define SET_FMC_CR_SYSFLASH_LOCK(Peri,Data)           SET_BIT_ADDR_OFFSET(Peri,FMC_REG_OFFSET_CTRL(Peri),Data,CFMC,CTRL,INFOLOCK)
...
#define SET_FMC_CR_ERS_4KB(Peri,Data)                 SET_BIT_ADDR_OFFSET(Peri,FMC_REG_OFFSET_CTRL(Peri),Data,CFMC,CTRL,S4KERS)
#endif
...
#define SET_FMC_WPR_WPROT(Peri,Idx,Data)              SET_REG(Peri,Data,FLSPROT)
#define GET_FMC_WPR_WPROT(Peri,Idx)                   GET_REG(Peri,FLSPROT)

/* CRC */
#define SET_FMC_CRC_START_ADDR(Peri,Data)             (void)Peri
#define SET_FMC_CRC_END_ADDR(Peri,Data)               (void)Peri
#define GET_FMC_CRC_RESULT(Peri)                      0
#define SET_FMC_CRC_CR_BACKGROUND_MODE(Peri,Data)     (void)Peri
#define SET_FMC_CRC_CR_BURST_MODE(Peri,Data)          (void)Peri
#define SET_FMC_CRC_CR_IRQ_EN(Peri,Data)              (void)Peri
#define SET_FMC_CRC_CR_RESET_CRC_DATA(Peri,Data)      (void)Peri
#define GET_FMC_STR_CRCBUSY(Peri)                     0
...
#define SET_CFMC_BANK_MODE(Peri,Data)                 (void)Peri
#define SET_CFMC_BANK_SWITCH(Peri,Data)               (void)Peri
#define GET_CFMC_BANK_MODE(Peri)                      0
#define GET_CFMC_BANK_SWITCH(Peri)                    0
#define GET_CFMC_BANK(Peri)                           0
