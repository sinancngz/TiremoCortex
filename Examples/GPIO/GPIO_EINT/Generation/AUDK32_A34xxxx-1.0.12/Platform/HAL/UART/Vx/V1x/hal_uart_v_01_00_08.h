...
#ifndef _HAL_UART_V_01_00_08_H_
#define _HAL_UART_V_01_00_08_H_

/* Feature(Function) Configuration Define */
#if defined(CONFIG_SCU_CLK_LSE_NO_FEATURE)
#define UART_FEATURE_UNSUPPORT_MCCR_LSE
#endif
