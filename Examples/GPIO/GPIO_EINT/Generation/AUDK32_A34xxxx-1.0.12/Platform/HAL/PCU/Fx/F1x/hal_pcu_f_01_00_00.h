/**
 *******************************************************************************
 * @file        hal_pcu_f_01_00_00.h
 * @author      ABOV R&D Division
 * @brief       Private APIs for ver 01.00.00 typed PCU
 *
...
#ifndef _HAL_PCU_F_01_00_00_H_
#define _HAL_PCU_F_01_00_00_H_
...
#if (CONFIG_PCU_REG_NAME == 1)
#define GET_PCU_IER_TRG_BASE_ADDR(Peri)               GET_REG_ADDR(Peri,PATRIG);
#define GET_PCU_IER_MODE_BASE_ADDR(Peri)              GET_REG_ADDR(Peri,PACR);
#define SET_PCU_IER_CFG_PORT_MODE(Addr,RegOff,DataOff,Data) \
                                                      SET_BIT_ADDR_DATA_OFFSET(Addr,RegOff,DataOff,Data,INTC,PATRIG,ITRIG0)
#define SET_PCU_IER_CFG_PORT_TRG(Addr,RegOff,DataOff,Data) \
                                                      SET_BIT_ADDR_DATA_OFFSET(Addr,RegOff,DataOff,Data,INTC,PACR,INTCTL0)
#else
