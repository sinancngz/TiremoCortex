/**
 *******************************************************************************
 * @file        hal_pcu_v_02_00_02.h
 * @author      ABOV R&D Division
 * @brief       Private APIs for ver 02.00.02 typed PCU
 *
...
#ifndef _HAL_PCU_V_02_00_02_H_
#define _HAL_PCU_V_02_00_02_H_

/* Internal Macro */
typedef PCU_Type                                      PORT_Type;
typedef PCU_Type                                      GPIO_Type;
typedef PCUEN_Type                                    PCU_PORTEN_Type;

#define PCU_REG_BASE                                  PA_BASE
#define PCU_REG_OFFSET                                0x100
#define PCU_PORT_EN_BASE                              PCUEN_BASE
...
#define SET_PCU_PORTEN(Peri,Data)                     SET_BIT(Peri,Data,PCUEN,PORTEN,PORTEN)
