/**
 *******************************************************************************
 * @file        hal_lcd_f_01_00_00.h
 * @author      ABOV R&D Division
 * @brief       Private APIs for ver 01.00.00 typed LCD
 *
...
#ifndef _HAL_LCD_F_01_00_00_H_
#define _HAL_LCD_F_01_00_00_H_
...
#if (CONFIG_LCD_REG_NAME == 1)
#define SET_LCD_BSSR_EXTBIASEN(Peri,Data)             (void)Peri
#define SET_LCD_BSSR_EXTPATH(Peri,Data)               SET_BIT(Peri,Data,LCD,BSSR,PVLC_OPEN)
#define SET_LCD_BSSR_VLC3EN(Peri,Data)                SET_BIT(Peri,Data,LCD,BSSR,VLC_PE3)
#define SET_LCD_BSSR_VLC2EN(Peri,Data)                SET_BIT(Peri,Data,LCD,BSSR,VLC_PE2)
#define SET_LCD_BSSR_VLC1EN(Peri,Data)                SET_BIT(Peri,Data,LCD,BSSR,VLC_PE1)
#define SET_LCD_BSSR_VLC0EN(Peri,Data)                SET_BIT(Peri,Data,LCD,BSSR,VLC_PE0)
#else
