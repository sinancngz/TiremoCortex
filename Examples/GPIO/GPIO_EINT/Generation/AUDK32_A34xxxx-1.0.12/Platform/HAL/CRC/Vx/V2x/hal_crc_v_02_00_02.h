/**
 *******************************************************************************
 * @file        hal_crc_v_02_00_02.h
 * @author      ABOV R&D Division
 * @brief       Private APIs for ver 02.00.02 typed CRC
 *
...
#ifndef _HAL_CRC_V_02_00_02_H_
#define _HAL_CRC_V_02_00_02_H_

/* Feature(Function) Configuration Define */
#define CRC_FEATURE_POLY_16CCITT
...
#define CRC_INT_POLY(x)                               (x == 4 ? 2 : x == 2 ? 3 : x )
...
/* Interrupt Macro */
#define SET_CRC_IER_DMA_FLAG(Peri,Data)               SET_BIT(Peri,Data,CRC,STAT,DMADINTEN)
#define GET_CRC_IER_DMA_FLAG(Peri)                    GET_BIT(Peri,CRC,STAT,DMADINT)
#define SET_CRC_IER_DMA_EN(Peri,Data)                 SET_BIT(Peri,Data,CRC,STAT,DMADINT)
