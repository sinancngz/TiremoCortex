/**
 *******************************************************************************
 * @file        hal_dac_v_02_00_00.h
 * @author      ABOV R&D Division
 * @brief       Private APIs for ver 02.00.00 typed DAC
 *
...
#ifndef _HAL_DAC_V_02_00_00_H_
#define _HAL_DAC_V_02_00_00_H_
...
#define SET_DAC_CR_PG(Peri,Data)                      SET_BIT(Peri,Data,DAC,PGSR,PSG)
...
/* Unused Macro */
#define GET_DAC_DR_ADDR(Peri)                         (void)0
...
#define SET_DAC_CR_PORT_EN(Peri,Data)                 (void)Peri; (void)Data
#define SET_DAC_CR_PORT1_EN(Peri,Data)                (void)Peri; (void)Data
#define SET_DAC_CR_PORT2_EN(Peri,Data)                (void)Peri; (void)Data
