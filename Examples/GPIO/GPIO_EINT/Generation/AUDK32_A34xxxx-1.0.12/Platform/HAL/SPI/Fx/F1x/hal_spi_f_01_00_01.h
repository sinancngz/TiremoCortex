...
#ifndef _HAL_SPI_F_01_00_01_H_
#define _HAL_SPI_F_01_00_01_H_
...
/* Internal Macro */
typedef SPI1_Type                                     SPI_Type;
#define SPI_REG_BASE                                  SPI1_BASE
#define SPI_REG_OFFSET                                0x80
#define SPI_BIT_ORDER(x)                              (x == 1 ? 0 : 1)

/* Bit/Register Macro */
#define SET_SPI_CR_MODE(Peri,Data)                    SET_BIT(Peri,Data,SPI1,CR,SPInMS)
#define SET_SPI_CR_BIT_ORDER(Peri,Data)               SET_BIT(Peri,SPI_BIT_ORDER(Data),SPI1,CR,FLSBn)
#define SET_SPI_CR_CPOL(Peri,Data)                    SET_BIT(Peri,Data,SPI1,CR,CPOLn)
#define SET_SPI_CR_CPHA(Peri,Data)                    SET_BIT(Peri,Data,SPI1,CR,CPHAn)
#define SET_SPI_CR_SS_EN(Peri,Data)                   SET_BIT(Peri,Data,SPI1,SR,SSnEN)
#define SET_SPI_DR_TX(Peri,Data)                      SET_BIT(Peri,Data,SPI1,TDR,TDATA)
#define SET_SPI_DR_RX(Peri,Data)                      SET_BIT(Peri,Data,SPI1,RDR,RDATA)
#define GET_SPI_DR_RX(Peri)                           GET_BIT(Peri,SPI1,RDR,RDATA)
#define SET_SPI_CR_EN(Peri,Data)                      SET_BIT(Peri,Data,SPI1,CR,SPInEN)
#define SET_SPI_CR_BAUDRATE(Peri,Data)                SET_BIT(Peri,Data,SPI1,PREDR,PRED)
#define GET_SPI_SR_TX_IDLE(Peri)                      GET_BIT(Peri,SPI1,SR,SSnHIGH)
#define GET_SPI_SR_TX_RDY(Peri)                       GET_BIT(Peri,SPI1,SR,SSnHIGH)
#define GET_SPI_SR_RX_RDY(Peri)                       GET_BIT(Peri,SPI1,SR,SSnHIGH)
#define GET_SPI_SR_BUSY(Peri)                         1
#define GET_SPI_CR_DATA_BIT(Peri)                     0
#define SET_SPI_CR_SWAP_PORT(Peri,Data)               SET_BIT(Peri,Data,SPI1,SR,FXCHn)
#define GET_SPI_DR_TX_ADDR(Peri)                      GET_REG_ADDR(Peri,TDR)
#define GET_SPI_DR_RX_ADDR(Peri)                      GET_REG_ADDR(Peri,RDR)

/* Interrupt Macro */
#define SET_SPI_IER_TX_EN(Peri,Data)                  SET_BIT(Peri,Data,SPI1,CR,SPInIEN)
#define SET_SPI_IER_RX_EN(Peri,Data)                  SET_BIT(Peri,Data,SPI1,CR,SPInIEN)
#define GET_SPI_IER_FLAG(Peri)                        GET_BIT(Peri,SPI1,SR,SPInIFLAG)
#define SET_SPI_IER_FLAG(Peri,Data)                   SET_BIT(Peri,Data,SPI1,SR,SPInIFLAG)
...
#define SET_SCU_SPI_PCER(Peri,Id,Data)                SET_BIT_ID(Peri,Id,Data,SCUCG,PPCLKEN2,SPI1CLKE)
#define SET_INTC_IRQ_UNMASK_EN(Peri,Irq,Data)         SET_BIT_ID(Peri,Irq,Data,INTC,MSK,IMSK0_LVI)
#endif /* _HAL_SPI_F_01_00_01_H_ */
