/**
 *******************************************************************************
 * @file        hal_spi_v_01_00_03.h
 * @author      ABOV R&D Division
 * @brief       Private APIs for ver 01.00.03 typed SPI
 *
...
#ifndef _HAL_SPI_V_01_00_03_H_
#define _HAL_SPI_V_01_00_03_H_
...
#elif (CONFIG_SPI_REG_NAME == 1) || (CONFIG_SPI_REG_NAME == 2)
#define SET_SPI_IER_DMATX_EN(Peri,Data)               SET_SPI_BIT(Peri,Data,CR,TXIE)
#define SET_SPI_IER_DMARX_EN(Peri,Data)               SET_SPI_BIT(Peri,Data,CR,RXIE)
#endif
