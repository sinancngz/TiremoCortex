...
#ifndef _HAL_ADC_V_01_00_04_H_
#define _HAL_ADC_V_01_00_04_H_
...
#define ADC_FEATURE_SEQUENCE_8_OVER
#define ADC_FEATURE_INPUT_MODE

/* Internal Macro */
#define ADC_REG_BASE                                  ADC0_BASE
#define ADC_REG_OFFSET                                0x100
#define ADC_RESOLUTION                                4095
#define ADC_MAX_SEQUENCE                              26
...
#define GET_ADC_DR_OUT(Addr)                          ((GET_BIT_ADDR(Addr,ADC,DR0,ADDATA) >> 4) & 0x0FFF)
#define GET_ADC_DR_CHINFO(Addr)                       GET_BIT_ADDR(Addr,ADC,DR0,ACH)
#define GET_ADC_DR_TRGINFO(Addr)                      GET_BIT_ADDR_MSK(Addr,0x1FUL,ADC,DR0,TRGINFO)
...
#define SET_ADC_CR_INMODE_SEL(Peri,Data)              SET_BIT(Peri,Data,ADC,MR,SINGLE_EN)
#define SET_ADC_CR_CMP_EN(Peri,Id,Data)               SET_BIT_OFFSET(Peri,(Id*4),Data,ADC,CMP0R,CMPEN)
#define SET_ADC_CR_CMP_TRG(Peri,Id,Data)              SET_BIT_OFFSET(Peri,(Id*4),Data,ADC,CMP0R,CMPM)
#define SET_ADC_CR_CMP_CH(Peri,Id,Data)               SET_BIT_OFFSET(Peri,(Id*4),Data,ADC,CMP0R,CCH)
#define SET_ADC_DR_CMP(Peri,Id,Data)                  SET_BIT_OFFSET(Peri,(Id*4),Data,ADC,CMP0R,CVAL)
#define SET_ADC_DR_CMP_MATCH(Peri,Id,Data)            SET_BIT_OFFSET(Peri,(Id*4),Data,ADC,CMP0R,MATCH_CNT)


#define GET_ADC_SCSR_BASE_ADDR(Peri)                  GET_REG_ADDR(Peri,SCSR1)
#define SET_ADC_CR_CH_SEL(Addr,Seq,Data)              SET_BIT_ADDR_DATA_OFFSET(Addr,((Seq/4)*4),((Seq%4)*8),Data,ADC,SCSR1,SEQ0CH)
#define GET_ADC_TRG_BASE_ADDR(Peri)                   GET_REG_ADDR(Peri,TRG1)
#define SET_ADC_CR_SEQTRG_SRC(Addr,Seq,Data)          SET_BIT_ADDR_DATA_OFFSET(Addr,((Seq/8)*4),((Seq%8)*4),Data,ADC,TRG1,SEQTRG0_BSTTRG)
...
#define SET_ADC_IER_CMP_EN(Peri,Id,Data)              SET_BIT(Peri,Data,ADC,CMP0R,CMPIEN)
...
#define SET_ADC_CR_REF(Peri,Data)                     SET_BIT(Peri,Data,ADC,MR,SEL_REF)
...
#define SET_SCU_ADC_MCCR_SEL(Peri,Data)               (void)Peri
#define SET_SCU_ADC_MCCR_DIV(Peri,Data)               (void)Peri

/* VREFBUF Macro*/
#define VREFBUF_ADDR                                  VREFBUF_BASE
#define VREFBUF_MODE_EXTERNAL                         0x01
#define VREFBUF_MODE_INTERNAL                         0x04
#define GET_VREFBUF_CR_MODE(Peri)                     GET_BIT(Peri,VREFBUF,CR,MODE_SEL)

#endif /* _HAL_ADC_V_01_00_04_H_ */
