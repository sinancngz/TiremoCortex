...
#ifndef _HAL_ADC_F1X_H_
#define _HAL_ADC_F1X_H_
...
#include "hal_adc_f_01_00_00.h"
#elif (CONFIG_ADC_VER_MINOR == 1)
#include "hal_adc_f_01_00_01.h"
#elif (CONFIG_ADC_VER_MINOR == 2)
#include "hal_adc_f_01_00_02.h"
#else
...
static __inline HAL_ERR_e ADC_SetSeqTrgSingle(ADC_Type *ptAdc, uint8_t un8ChNum, P_ADC_TRG_e eTrg, uint8_t un8TrgNum)
{
    SET_ADC_CR_CH_SEL0(ptAdc, un8ChNum, ADC_SEQ_CH_OFFSET);
    SET_ADC_CR_SEQTRG_SRC(ptAdc, ADC_SEQTRG_SRC(eTrg, un8TrgNum), ADC_SEQ_CH_OFFSET); 
    return HAL_ERR_OK;
}
