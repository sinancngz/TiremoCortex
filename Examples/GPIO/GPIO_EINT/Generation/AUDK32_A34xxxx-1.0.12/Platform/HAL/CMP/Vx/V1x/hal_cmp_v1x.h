 ...
 * @brief       Private APIs for V1x typed CMP
 *
...
#ifndef _HAL_CMP_V1X_H_
#define _HAL_CMP_V1X_H_
...
#include "hal_cmp_v_01_00_00.h"
#elif (CONFIG_CMP_VER_MINOR == 1)
#include "hal_cmp_v_01_00_01.h"
#else
#error "define CONFIG_CMP_VER_MINOR of V-type CMP at config_xxx.h"
#endif

#elif (CONFIG_CMP_VER_EXT == 1)

#if (CONFIG_CMP_VER_MINOR == 0)
#include "hal_cmp_v_01_01_00.h"
#else
#error "define CONFIG_CMP_VER_MINOR of V-type CMP at config_xxx.h"
#endif
