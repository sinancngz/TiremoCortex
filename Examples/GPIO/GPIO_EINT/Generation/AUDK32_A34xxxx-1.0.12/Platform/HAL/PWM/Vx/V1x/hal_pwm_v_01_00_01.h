...
#ifndef _HAL_PWM_V_01_00_01_H_
#define _HAL_PWM_V_01_00_01_H_
...
#define PWM_REG_PWM_OFFSET                            0x100
#define PWM_ID_DIV(x)                                 (x / 5)
#define PWM_ID_MOD(x)                                 (x % 5)

#define PWM_PRS_REG_BASE                              PWMPRS0_BASE
#define PWM_PRS_REG_OFFSET                            0x100

#define PWM_PRS_ID(x)                                 (x < 5 ? 0 : 1)

/* Bit/Register Macro */
#define SET_PWM_DR_PERIOD(Peri,Data)                  SET_BIT(Peri,Data,PWM0,PER,PERIOD)
#define SET_PWM_DR_DUTY(Peri,Data)                    SET_BIT(Peri,Data,PWM0,COMP,COMP)
...
#define SCU_ENABLE(x)                                 (x < 5 ? 0 : 1)
#define SET_SCU_PWM_PER(Peri,Id,Data)                 SET_BIT_ID(Peri,Id,Data,SCU,PER3,PWM04)
#define SET_SCU_PWM_PCER(Peri,Id,Data)                SET_BIT_ID(Peri,Id,Data,SCU,PCER3,PWM04)

#endif /* _HAL_PWM_V_01_00_01_H_ */
