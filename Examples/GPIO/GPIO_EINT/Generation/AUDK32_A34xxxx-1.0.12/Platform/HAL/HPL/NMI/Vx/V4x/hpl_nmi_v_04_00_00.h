/**
 *******************************************************************************
 * @file        hpl_nmi_v_04_00_00.h
 * @author      ABOV R&D Division
 * @brief       Private APIs for ver 04.00.00 typed SCU NMI 
 *
...
#ifndef _HPL_NMI_V_04_00_00_H_
#define _HPL_NMI_V_04_00_00_H_
...
#define SET_SCU_NMI_OVP0_IER_EN(Peri,Data)            (void)Peri
#define SET_SCU_NMI_OVP1_IER_EN(Peri,Data)            (void)Peri
#define SET_SCU_NMI_PROT0_IER_EN(Peri,Data)           (void)Peri
#define SET_SCU_NMI_PROT1_IER_EN(Peri,Data)           (void)Peri

#endif /* _HPL_NMI_V_04_00_00_H_ */
