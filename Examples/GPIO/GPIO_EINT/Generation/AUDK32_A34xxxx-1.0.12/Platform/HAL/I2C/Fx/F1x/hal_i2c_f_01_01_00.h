/**
 *******************************************************************************
 * @file        hal_i2c_f_01_01_00.h
 * @author      ABOV R&D Division
 * @brief       Private APIs for ver 01.01.00 typed I2C
 *
...
#ifndef _HAL_I2C_F_01_01_00_H_
#define _HAL_I2C_F_01_01_00_H_

/* Feature(Function) Configuration Define */
#define I2C_FEATURE_WAKEUP                              
...
#define SET_I2C_CR_SDA_HOLD_EN(Peri,Data)             SET_BIT(Peri,(Data == 0 ? 0x01 : 0x00),I2C0,MR,DIS_SDAH)
...
#define SET_SCU_I2C_WKUP_EN(Peri,Offset,Data)         SET_BIT_OFFSET(Peri,Offset,Data,SCU,WUER,I2C0WUE)
#define GET_SCU_I2C_WKUP_EN(Peri,Offset)              GET_BIT_OFFSET(Peri,Offset,SCU,WUER,I2C0WUE)
#define GET_SCU_I2C_WKUP_FLAG(Peri,Offset)            GET_BIT_OFFSET(Peri,Offset,SCU,WUSR,I2C0WU)
#define GET_SCU_I2C_PREVMODE(Peri)                    GET_BIT(Peri,SCU,SMR,PREVMODE)

#endif /* _HAL_I2C_F_01_01_00_H_ */
