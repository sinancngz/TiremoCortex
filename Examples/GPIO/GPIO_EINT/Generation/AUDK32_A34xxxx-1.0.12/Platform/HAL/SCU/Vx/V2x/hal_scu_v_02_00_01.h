...
#ifndef _HAL_SCU_V_02_00_01_H_
#define _HAL_SCU_V_02_00_01_H_
...
#define GET_SCU_PLLCON_LOCK(Peri)                     GET_BIT(Peri,SCU,PLLCON,LOCKSTS)
...
#define BIT_SCU_EOS_HSENC_EN                          BIT_NAME_POS(SCU_,EOSCR_,ENFEN_)
#define BIT_SCU_EOS_HSENC_DELAY                       BIT_NAME_POS(SCU_,EOSCR_,ENFSEL_)
#define BIT_SCU_EOS_HSE_CURR                          BIT_NAME_POS(SCU_,EOSCR_,EISEL_)
