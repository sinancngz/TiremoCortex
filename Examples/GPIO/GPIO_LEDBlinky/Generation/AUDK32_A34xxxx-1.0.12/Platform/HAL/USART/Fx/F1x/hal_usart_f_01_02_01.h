...
#ifndef _HAL_USART_F_01_02_01_H_
#define _HAL_USART_F_01_02_01_H_

/* Feature(Function) Configuration Define */
#define USART_FEATURE_WAKEUP
#define USART_FEATURE_RX_TIME_OUT
#define USART_FEATURE_RX_DISABLE_IN_SPI_SLAVE
#define USART_FEATURE_NOT_SUPPORT_PREVMODE
...
#define SET_USART_CR_SSEN(Peri,Data)                  (void)Peri
...
#define SET_USART_CR_RTO_CNT(Peri,Data)               SET_BIT(Peri,Data,USART,RTO,DATA)
#define SET_USART_CR_SREN(Peri,Data)                  SET_BIT(Peri,Data,USART,CR2,SREN)

/* Interrupt Macro */
#define SET_USART_IER_RTO_EN(Peri,Data)               SET_BIT(Peri,Data,USART,CR2,RTOIE)
#define SET_USART_IER_WAKE_EN(Peri,Data)              SET_BIT(Peri,Data,USART,CR1,WAKEIE)
...
#define USART_WKUP_OFFSET                             0
#define SET_SCU_USART_WKUP_EN(Peri,Offset,Data)       SET_BIT_OFFSET(Peri,Offset,Data,SCU,WUER,USART10WUE)
#define GET_SCU_USART_WKUP_EN(Peri,Offset)            GET_BIT_OFFSET(Peri,Offset,SCU,WUER,USART10WUE)
#define GET_SCU_USART_WKUP_FLAG(Peri,Offset)          GET_BIT_OFFSET(Peri,Offset,SCU,WUSR,USART10WU)
#define GET_SCU_USART_PREVMODE(Peri)                  GET_BIT(Peri,SCU,SMR,PREVMODE)

#endif /* _HAL_USART_F_01_02_01_H_ */
