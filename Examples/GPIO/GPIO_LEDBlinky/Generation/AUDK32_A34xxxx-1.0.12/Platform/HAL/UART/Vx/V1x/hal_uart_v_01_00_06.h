/**
 *******************************************************************************
 * @file        hal_uart_v_01_00_03.h
 * @author      ABOV R&D Division
 * @brief       Private APIs for ver 01.00.03 typed UART
 *
...
#ifndef _HAL_UART_V_01_00_03_H_
#define _HAL_UART_V_01_00_03_H_

/* Feature(Function) Configuration Define */
#define UART_FEATURE_MCCR
...
#define GET_UART_LSR(Peri)                            GET_REG(Peri,ELSR)
...
#define GET_UART_LSR_PE(Peri)                         GET_BIT(Peri,UART,ELSR,PEIF)
...
#define GET_UART_LSR_TEMT(Peri)                       GET_BIT(Peri,UART,ELSR,TEMTIF)
#define GET_UART_LSR_THRE(Peri)                       GET_BIT(Peri,UART,ELSR,THRE)
#define GET_UART_LSR_BI(Peri)                         GET_BIT(Peri,UART,ELSR,BIIF)
#define GET_UART_LSR_FE(Peri)                         GET_BIT(Peri,UART,ELSR,FEIF)
#define GET_UART_LSR_OE(Peri)                         GET_BIT(Peri,UART,ELSR,OEIF)
#define GET_UART_LSR_DR(Peri)                         GET_BIT(Peri,UART,ELSR,DR)
...
#define SET_UART_RBR_DATA(Peri,Data)                  SET_BIT(Peri,Data,UART,RBR,DATA)
#define GET_UART_RBR_DATA(Peri)                       GET_BIT(Peri,UART,RBR,DATA)
#define SET_UART_THR_DATA(Peri,Data)                  SET_BIT(Peri,Data,UART,THR,DATA)
#define GET_UART_THR_DATA(Peri)                       GET_BIT(Peri,UART,THR,DATA)
#else
...
#define GET_UART_IER_THREIE(Peri)                     GET_BIT(Peri,IER,UART,THREIE)
...
#define SCU_UART_MCCR_MODE(x)                         (x == 0 ? x : x + 2)
#define SET_SCU_UART_PER(Peri,Id,Data)                (Id > 7 ? SET_BIT_ID(Peri,(Id % 8),Data,SCU,PER3,UART8) : SET_BIT_ID(Peri,Id,Data,SCU,PER2,UART0))
#define SET_SCU_UART_PCER(Peri,Id,Data)               (Id > 7 ? SET_BIT_ID(Peri,(Id % 8),Data,SCU,PCER3,UART8) : SET_BIT_ID(Peri,Id,Data,SCU,PCER2,UART0))
#define SET_SCU_UART_MCCR_SEL(Peri,Data)              SET_BIT(Peri,Data,SCU,MCCR7,UARTCSEL)
#define SET_SCU_UART_MCCR_DIV(Peri,Data)              SET_BIT(Peri,Data,SCU,MCCR7,UARTCDIV)
#define GET_SCU_UART_MCCR_DIV(Peri)                   GET_BIT(Peri,SCU,MCCR7,UARTCDIV)

#endif /* _HAL_UART_V_01_00_03_H_ */
