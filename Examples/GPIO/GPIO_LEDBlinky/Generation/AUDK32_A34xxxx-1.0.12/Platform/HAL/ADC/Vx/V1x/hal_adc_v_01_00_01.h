...
#ifndef _HAL_ADC_V_01_00_01_H_
#define _HAL_ADC_V_01_00_01_H_
...
#define ADC_TRG_SRC(x)                                (x == 0 ? 0 : 1)
#define ADC_SEQTRG_SRC(x,y)                           (x == 1 ? y : (x == 2) ? 4+y : (x == 3) ? 6 : (x == 4) ? 7 : (x == 0) ? 15 : ADC_NO_TRG_SOURCE)
...
#define SET_ADC_CR_SEQTRG_SRC(Peri,Data,Offset)       SET_BIT_OFFSET(Peri,Offset,Data,ADC,TRG,SEQTRG0)
...
#define SET_ADC_CR_PCLKINV(Peri,Data)                 SET_BIT(Peri,Data,ADC,CCR,CLKINIVT)
#define SET_ADC_CR_CMP_EN(Peri,Id,Data)               SET_BIT(Peri,Data,ADC,CMPR,COMPEN)
...
#define BIT_ADC_IER_CMP_FLAG(Id)                      (0x1UL << BIT_NAME_POS(ADC_,SR_,COMPIFLG_))
#define SET_ADC_IER_CMP_EN(Peri,Id,Data)              SET_BIT(Peri,Data,ADC,CMPR,COMPIEN)
