...
#ifndef _HAL_CMP_F_01_00_00_H_
#define _HAL_CMP_F_01_00_00_H_

/* Feature(Function) Configuration Define */
#define CMP_FEATURE_IRQ_UNMASK_ENABLE
#define CMP_FEATURE_INTERNAL_REFERENCE_VOLTAGE_LEVEL
...
#define SET_CMP_CR_HYSS(Peri,Id,Data)                 SET_BIT_ID(Peri,0,CMP_HYSS_ENABLE(Data),CMPn,CR,HYSnEN)
...
#define SET_CMP_CR_INTREF_EN(Peri,Data)               SET_BIT(Peri,Data,CMPn,RCR,REFnEN)
#define SET_CMP_CR_INTREF_VOL_LVL(Peri,Data)          SET_BIT(Peri,Data,CMPn,RCR,CMPnREF)
