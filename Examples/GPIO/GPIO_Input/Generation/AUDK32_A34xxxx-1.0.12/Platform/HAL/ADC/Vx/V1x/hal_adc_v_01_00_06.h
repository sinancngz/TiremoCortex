...
#ifndef _HAL_ADC_V_01_00_06_H_
#define _HAL_ADC_V_01_00_06_H_
...
#define BIT_ADC_IER_CMP_FLAG(Id)                      (0x1UL << (BIT_NAME_POS(ADC_,SR_,CMP1IF_)+Id))
#define SET_ADC_IER_CMP_EN(Peri,Id,Data)              SET_BIT_OFFSET(Peri,Id,Data,ADC,IER,CMP1IE)
#define GET_ADC_IER_CMP_FLAG(Peri,Id)                 GET_BIT_OFFSET(Peri,Id,ADC,SR,CMP1IF)
#define SET_ADC_IER_CMP_FLAG(Peri,Id,Data)            SET_BIT_OFFSET(Peri,Id,Data,ADC,SR,CMP1IF)
