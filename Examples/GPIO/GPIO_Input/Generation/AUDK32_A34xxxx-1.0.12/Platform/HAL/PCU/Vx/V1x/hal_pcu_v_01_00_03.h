/**
 *******************************************************************************
 * @file        hal_pcu_v_01_00_03.h
 * @author      ABOV R&D Division
 * @brief       Private APIs for ver 01.00.03 typed PCU
 *
...
#ifndef _HAL_PCU_V_01_00_03_H_
#define _HAL_PCU_V_01_00_03_H_

/* Feature(Function) Configuration Define */
#define PCU_FEATURE_PORT_STRENGTH
#define PCU_FEATURE_PORT_F_LEVEL

/* Internal Macro */
typedef PORT_Type                                     GPIO_Type;
typedef PCU2_Type                                     PCU_PORTEN_Type;
#define PCU_PORT_EN_BASE                              PCU2_BASE
...
#define SET_PCU_PORTEN(Peri,Data)                     SET_BIT(Peri,Data,PCU2,PORTEN,PORTEN)
...
static __inline void PCU1_INT_IRQHandler(void)
{
    ...
    ptPcu = (PORT_Type *)(PCU_REG_BASE + (PCU_REG_OFFSET * PCU_ID_D));
    un32Status = GET_PCU_ISR_REG(ptPcu);
    if(un32Status)
    {
