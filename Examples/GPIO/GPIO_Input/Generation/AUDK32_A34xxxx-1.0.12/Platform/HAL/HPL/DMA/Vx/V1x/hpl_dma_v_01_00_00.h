...
#ifndef _HPL_DMA_V_01_00_00_H_
#define _HPL_DMA_V_01_00_00_H_

/* Feature(Function) Configuration Define */

/* Internal Macro */
#if (CONFIG_DMA_REG_NAME == 0)
typedef DMA0_Type                                     DMA_Type;
#define SET_DMA_BIT(Peri,Data,RegName,BitName)        SET_BIT(Peri,Data,DMA0,RegName,BitName)
#define GET_DMA_BIT(Peri,RegName,BitName)             GET_BIT(Peri,DMA0,RegName,BitName)
#define DMA_REG_BASE                                  DMA0_BASE
#elif (CONFIG_DMA_REG_NAME == 1)
typedef DMAC0_Type                                    DMA_Type;
