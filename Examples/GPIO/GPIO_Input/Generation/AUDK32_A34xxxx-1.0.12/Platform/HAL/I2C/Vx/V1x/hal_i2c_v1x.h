 ...
 * @brief       Private APIs for V1x typed I2C
 *
...
#ifndef _HAL_I2C_V1X_H_
#define _HAL_I2C_V1X_H_
...
#if (CONFIG_I2C_REG_NAME == 2)
#include "hal_i2c_v_01_00_00_02.h"
#else
#include "hal_i2c_v_01_00_00.h"
#endif

#elif (CONFIG_I2C_VER_MINOR == 1)
#include "hal_i2c_v_01_00_01.h"

#else
#error "define CONFIG_I2C_VER_MINOR of V-type I2C at config_xxx.h"
#endif

#else
#error "define CONFIG_I2C_VER_EXT of V-type I2C at config_xxx.h"
#endif
