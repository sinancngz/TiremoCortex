...
#define SCU_FEATURE_UNSUPPORT_LSE_NC_ENABLE
...
#define SCUCLK_EXT_LSE_CURR(x)                        (x & 0xF)
#define SCUCLK_EXT_HSE_MSK                            0xFFFFFC00
#define SCUCLK_EXT_LSE_MSK                            0xF0FFFFFF
...
#define SET_SCU_CMR_MCLKIE(Peri,Data)                 (void)Peri
#define SET_SCU_CMR_MCLKFAIL(Peri,Data)               (void)Peri
#define GET_SCU_CMR_MCLKFAIL(Peri)                    0
