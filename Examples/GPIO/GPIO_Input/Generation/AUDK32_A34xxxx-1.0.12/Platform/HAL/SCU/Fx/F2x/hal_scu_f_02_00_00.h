...
#ifndef _HAL_SCU_F_02_00_00_H_
#define _HAL_SCU_F_02_00_00_H_
...
#define SCU_FEATURE_PLL_ENABLE_AFTER_SETTING
#define SCU_FEATURE_PLL_OUTPUT_FORMULA_V2
...
#define SCUCLK_MCLKSEL_PLL                            0x04
...
#define SCUCLK_HDIV(x)                                (x == P_SCUCLK_DIV_2 ? 3 : \
                                                      (x == P_SCUCLK_DIV_4 ? 2 : \
                                                      (x == P_SCUCLK_DIV_8 ? 1 : \
                                                      (x == P_SCUCLK_DIV_16 ? 0 : 4))))
...
#define SET_SCU_CSCR_HSI(Peri,Data)                   SET_BIT_KEY(Peri,0xA507,Data,SCUCG,CLKSRCR,HSIEN)
#define SET_SCU_CSCR_HSI_SEL(Peri,Data)               SET_BIT_KEY(Peri,0xA507,(Data & 0x03),SCUCG,CLKSRCR,HSISEL)
#define SET_SCU_CSCR_WDT(Peri,Data)                   SET_BIT_KEY(Peri,0xA507,Data,SCUCG,CLKSRCR,LSIEN)
#define SET_SCU_CSCR_HSE(Peri,Data)                   SET_BIT_KEY(Peri,0xA507,Data,SCUCG,CLKSRCR,HSEEN)
#define SET_SCU_CSCR_LSE(Peri,Data)                   SET_BIT_KEY(Peri,0xA507,Data,SCUCG,CLKSRCR,LSEEN)
...
#define SET_SCU_PMU_DS_MODE(Peri,Data)                (void)Peri
#define GET_SCU_PMU_DS_MODE(Peri)                     (void)Peri
#define SET_SCU_PMU_CFLASH_EN(Peri,Data)              (void)Peri
#define SET_SCU_PMU_DFLASH_EN(Peri,Data)              (void)Peri
#define SET_SCU_PMU_DS1_WKUP_EN(Peri,Data)            (void)Peri
#define SET_SCU_PMU_DS1_WKUP_FLAG(Peri,Data)          (void)Peri
#define GET_SCU_PMU_DS1_WKUP_FLAG(Peri)               (void)Peri
#define GET_SCU_PMU_DS2_WKUP_FLAG(Peri)               (void)Peri
#define GET_SCU_PMU_DS3_WKUP_FLAG(Peri)               (void)Peri
#define SET_SCU_PMU_BACKUP(Addr,Offset,Data)          (void)Addr
#define GET_SCU_PMU_BACKUP_ADDR(Peri)                 (void)Peri
#define GET_SCU_PMU_ADDR(Peri)                        (void)Peri
#define SET_SCU_PMU_WKUP_EN(Addr,Data)                (void)Addr
#define GET_SCU_PMU_PUPD_BASE_ADDR(Peri)              (void)Peri
#define SET_SCU_PMU_PUPD(Addr,Data)                   (void)Addr
...
#define SET_SCU_PLLCON_POSTDIV1(Peri,Data)            SET_BIT(Peri,Data,SCUCG,PLLCON,POSTDIV1)
#define SET_SCU_PLLCON_POSTDIV2(Peri,Data)            SET_BIT(Peri,Data,SCUCG,PLLCON,POSTDIV2)
#define SET_SCU_PLLCON_PREDIV(Peri,Data)              SET_BIT(Peri,Data,SCUCG,PLLCON,PREDIV)
#define SET_SCU_PLLCON_PLLMODE(Peri,Data)             (void)Peri
#define SET_SCU_PLLCON_PLLEN(Peri,Data)               SET_BIT_KEY(Peri,0xA507,Data,SCUCG,CLKSRCR,PLLEN)
...
#define SET_SCU_SCCR_PLLCLKSEL(Peri,Data)             SET_BIT_KEY(Peri,0x570A,Data,SCUCG,SCCR,PLLINCLKSEL)
#define GET_SCU_PLLCON_LOCK(Peri)                     GET_BIT(Peri,SCUCG,PLLCON,PLLLOCK)
#define GET_SCU_PLLCON(Peri)                          GET_REG(Peri,PLLCON)
#define SET_SCU_PLLCON_PLLEN_POS(Data)                0
#define SET_SCU_PLLCON_OUTDIV_POS(Data)               SET_POS((Data & 0xFF),SCUCG,PLLCON,FBDIV)
#define SET_SCU_PLLCON_POSTDIV1_POS(Data)             SET_POS((Data & 0x0F),SCUCG,PLLCON,POSTDIV1)
#define SET_SCU_PLLCON_POSTDIV2_POS(Data)             SET_POS((Data & 0x0F),SCUCG,PLLCON,POSTDIV2)
#define SET_SCU_PLLCON_PREDIV_POS(Data)               SET_POS((Data & 0x0F),SCUCG,PLLCON,PREDIV)
