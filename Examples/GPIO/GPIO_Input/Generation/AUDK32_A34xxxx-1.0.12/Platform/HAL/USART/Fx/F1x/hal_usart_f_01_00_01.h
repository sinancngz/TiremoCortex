/**
 *******************************************************************************
 * @file        hal_usart_f_01_00_01.h
 * @author      ABOV R&D Division
 * @brief       Private APIs for ver 01.00.01 typed USART
 *
...
#ifndef _HAL_USART_F_01_00_01_H_
#define _HAL_USART_F_01_00_01_H_
...
#define SET_USART_CR_TXBIT_NINTH(Peri,Data)           SET_BIT(Peri,Data,USART1n,CR2,USTnTX8)
#define SET_USART_CR_RXBIT_NINTH(Peri,Data)           SET_BIT(Peri,Data,USART1n,CR2,USTnRX8)
#define GET_USART_CR_RXBIT_NINTH(Peri)                GET_BIT(Peri,USART1n,CR2,USTnRX8)
#define SET_USART_CR_DBLS(Peri,Data)                  SET_BIT(Peri,Data,USART1n,CR2,DBLSn)
#define SET_USART_DR(Peri,Data)                       SET_BIT(Peri,Data,USART1n,DR,DATA)
#define GET_USART_DR(Peri)                            GET_BIT(Peri,USART1n,DR,DATA)
