 ...
 * @brief       Private APIs for V4x typed SCU
 *
...
#ifndef _HAL_SCU_V4X_H_
#define _HAL_SCU_V4X_H_
...
#include "hal_scu_v_04_00_00.h"
#elif (CONFIG_SCU_VER_MINOR == 1)
#include "hal_scu_v_04_00_01.h"
#else
                                         ...
                                         P_SCUCLK_DIV_e ePostMClkDiv)
{
    ...
    switch(eMClk)
    {
        ...
        case P_SCUCLK_SRC_HSI:
            ...
            break;
#if defined(SCU_FEATURE_UNSUPPORT_MCLK_SRC_LSI)
#else
        case P_SCUCLK_SRC_LSI:
...
{
    SCU_Type *ptScu = (SCU_Type *)SCU_REG_BASE;
#if defined(SCU_FEATURE_NOT_SUPPORT_PREVMODE)
