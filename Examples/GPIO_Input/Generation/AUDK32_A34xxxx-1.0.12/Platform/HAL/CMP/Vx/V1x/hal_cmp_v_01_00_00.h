/**
 *******************************************************************************
 * @file        hal_cmp_v_01_00_00.h
 * @author      ABOV R&D Division
 * @brief       Private APIs for ver 01.00.00 typed CMP
 *
...
#ifndef _HAL_CMP_V_01_00_00_H_
#define _HAL_CMP_V_01_00_00_H_
...
#define SET_CMP_CR_EN(Peri,Id,Data)                   SET_BIT_ADDR_OFFSET(Peri,(Id*CMP_CR_REG_OFFSET),Data,CMP,CMP0CR,COMP0EN)
#define SET_CMP_CR_HYSS_EN(Peri,Id,Data)              SET_BIT_ADDR_OFFSET(Peri,(Id*CMP_CR_REG_OFFSET),Data,CMP,CMP0CR,HYSEN0)
#define SET_CMP_CR_HYSS_MODE(Peri,Id,Data)            SET_BIT_ADDR_OFFSET(Peri,(Id*CMP_CR_REG_OFFSET),Data,CMP,CMP0CR,HYSSEL0)
...
#define SET_CMP_CR_INTR_POL(Peri,Id,Data)             SET_BIT_OFFSET(Peri,(Id*1),Data,CMP,ICON,IPOL0)
#define SET_CMP_CR_TRG_POL(Peri,Id,Data)              SET_BIT_OFFSET(Peri,(Id*1),Data,CMP,ICON,TPOL0)
#define SET_CMP_DR_DBNC_CLK_DIV(Peri,Data)            SET_BIT(Peri,Data,CMP,DBNC,DBINCTB)
